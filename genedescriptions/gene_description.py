...
class GeneDescription(object):
    ...
    @staticmethod
    def _get_module_initial_num(aspect: str, sentence_generator: OntologySentenceGenerator, main_qualifier: str = "",
                                additional_qualifier: str = None):
        return len(GeneDescription._get_module_initial_set(aspect, sentence_generator, main_qualifier,
                                                           additional_qualifier))

    @staticmethod
    def _get_module_initial_set(aspect: str, sentence_generator: OntologySentenceGenerator, main_qualifier: str = "",
                                additional_qualifier: str = None):
        if not additional_qualifier:
            return [elem for key, sets in sentence_generator.terms_groups[(aspect, main_qualifier)].items() for elem
