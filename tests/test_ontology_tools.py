...
class TestOntologyTools(unittest.TestCase):
    ...
    def test_information_content(self):
        ...
        #            /| |\
        #           / | | \
        #          1  2a 3 4b              ic(1) = 0.693147181, ic(2) = 0.470003629, ic(3) = 0.980829253
        #         /\ /\/ \/
        #        /  5 6  7                 ic(5) = 0.980829253, ic(6) = 1.16315081, ic(7) = 1.16315081
        #       /  /\  \/
        #      / 8c  9 10                  ic(8) = 1.049822124, ic(10) = 1.252762968
        #      \ / \/   \
        #      11  12a  13b                ic(11) = 1.386294361, ic(12) = 1.386294361, ic(13) = 1.386294361
