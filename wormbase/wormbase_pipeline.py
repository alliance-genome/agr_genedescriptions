...
def set_tissue_expression_sentence(dm, gene, conf_parser, gene_desc):
    ...
    gene_desc.set_or_update_initial_stats(module=Module.EXPRESSION, module_sentences=expression_module_sentences,
                                          sent_generator=expr_sentence_generator)
    ...
    if protein_domains:
        ...
        gene_desc.set_or_extend_module_description_and_final_stats(
            ...
            description="is predicted to encode a protein with the following " + dom_word + ": " +
                        concatenate_words_with_oxford_comma([ptdom[1] for ptdom in protein_domains if ptdom[1] != ""],
