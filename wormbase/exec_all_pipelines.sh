...
cat /usr/caltech_curation_files/pub/gene_descriptions/${WB_RELEASE}/pre-release/*.ace > automatedesc.ace
rm /usr/caltech_curation_files/pub/gene_descriptions/${WB_RELEASE}/pre-release/*.ace
mv automatedesc.ace /usr/caltech_curation_files/pub/gene_descriptions/${WB_RELEASE}/pre-release/${today_folder}
python3 /usr/src/gene_descriptions/manualdesc_postgres2ace.py > /usr/caltech_curation_files/pub/gene_descriptions/${WB_RELEASE}/pre-release/${today_folder}/${today_folder}_manualdesc.ace
python3 /usr/src/gene_descriptions/create_overall_stats_file.py -i /usr/caltech_curation_files/pub/gene_descriptions/${WB_RELEASE}/pre-release/${today_folder} -m /usr/caltech_curation_files/pub/gene_descriptions/${WB_RELEASE}/pre-release/${today_folder}/${today_folder}_manualdesc.ace > /usr/caltech_curation_files/pub/gene_descriptions/${WB_RELEASE}/pre-release/${today_folder}/${today_folder}__number_of_concise_descriptions.txt
